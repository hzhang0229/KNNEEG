...
class kNNAttention(nn.Module):
    def __init__(self, dim, num_heads=12, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0.,topk=210):
        super().__init__()
...
def vit_base_patch16_224_in21k(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(
        patch_size=(3,50), embed_dim=768, depth=12, num_heads=12, representation_size=768, **kwargs)
